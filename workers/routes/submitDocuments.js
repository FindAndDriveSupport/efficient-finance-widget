 ...
 *
 * Calls Edith webservice SubmitDocuments to attach documents to a policy.
 * Used by the "Fast Application" flow — after CreatePolicy returns a
 * PolicyNumber, the frontend uploads documents (base64) which are
 * forwarded here and attached to that policy.
 *
 * Request body:
 * {
 *   policyNumber: string,
 *   documents: [
 *     {
 *       category: 'ID DOCUMENT' | 'PASSPORT' | 'BANK STATEMENT' | 'SALARY SLIP' | 'PROOF OF RESIDENCE' | ...,
 *       description?: string,
